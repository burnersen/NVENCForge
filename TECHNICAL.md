...
| `autoCQMaxSourcePercent` | `0` (off) | Spending limit for the search, as a share of the source bitrate. `40` = never use more than 40 % of what the source itself spends; the search then takes the cheapest CQ that still fits and says so in the log. Valid: `0`, or `10`–`100` |
